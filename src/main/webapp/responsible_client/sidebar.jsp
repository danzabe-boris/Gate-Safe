  ...
  <li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="view-customer.jsp">My Customers</a>
        <a class="collapse-item" href="current_command.jsp">Current commands</a>
        <a class="collapse-item" href="finalize_command.jsp">Finalize commands</a>
